  ...
  return (
    <section id="hero" ref={sectionRef} style={{
      ...
      <div style={{
        ...
        <div ref={cardsRef} style={{ flex: 1, position: 'relative', display: 'flex', flexDirection: 'column', gap: '24px', paddingTop: '80px', alignItems: 'flex-end' }}>
          ...
          <GlassPanel glowColor="none" style={{ maxWidth: '400px', marginTop: 'auto', padding: '24px' }}>
            <div style={{ fontFamily: 'var(--font-roboto-mono)', fontSize: '10px', color: 'var(--color-paper-white)', letterSpacing: '0.1em', marginBottom: '16px' }}>CONCURRENT WORKERS</div>
            <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
              <span style={{ fontFamily: 'var(--font-lambotype)', fontSize: '32px', color: 'var(--color-paper-white)' }}>16</span>
              <div style={{ display: 'flex', gap: '4px' }}>
                {[...Array(16)].map((_, i) => (
                  <div key={i} style={{
                    width: '6px',
                    height: '20px',
                    background: i < 12 ? 'var(--color-network-cyan)' : 'var(--color-packet-violet)',
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>| NET | TCP | GOROUTINES | EPOLL (IOCP ON WINDOWS) | ZERO DEPENDENCIES</div>
        </div>
      </div>
    </section>
  );
